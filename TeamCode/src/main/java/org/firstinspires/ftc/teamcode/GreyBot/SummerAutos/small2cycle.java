...
@Config
@Autonomous(name="small2cycle", group = "summer")
public class small2cycle extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 3:
                if(!follower.isBusy()){
                    follower.followPath(goShot3, .7, true);
                    intakeTimer.reset();
