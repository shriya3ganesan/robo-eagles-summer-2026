...
@Config
@Autonomous(name="biggate", group = "summer")
public class biggate extends OpMode {
    ...
    private final Pose pose2 = new Pose(46, 100);
    private final Pose pose3 = new Pose(56, 85);
    private final Pose pose4 = new Pose(25, 85);
    private final Pose pose5 = new Pose(50, 70);
    private final Pose pose6 = new Pose(25, 70);
    ...
    public void buildPaths() {
        ...
        path7 = follower.pathBuilder()
                .addPath(new BezierLine(pose6, pose5))
                .setLinearHeadingInterpolation(Math.toRadians(0),Math.toRadians(0))
                .build();
    }
