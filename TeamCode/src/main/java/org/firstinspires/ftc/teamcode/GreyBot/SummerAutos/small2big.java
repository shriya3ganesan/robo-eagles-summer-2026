...
@Config
@Autonomous(name="small2big", group = "summer")
public class small2big extends OpMode {
    ...
    private final Pose pose2 = new Pose(50, 130);
    private final Pose shotpose = new Pose(10, 8, Math.toDegrees(90));
    private final Pose collect1 = new Pose(25, 95, Math.toDegrees(90));
    private final Pose collect2 = new Pose(25, 71, Math.toDegrees(90));

    private PathChain goShot, goCollect, goshot2, gocollect2, goShot3;
