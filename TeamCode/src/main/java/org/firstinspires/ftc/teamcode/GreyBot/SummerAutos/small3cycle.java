...
@Config
@Autonomous(name="small3cycle", group = "summer")
public class small3cycle extends OpMode {
    ...
    private final Pose startPose = new Pose(56, 8, Math.toRadians(105));
    private final Pose pose2 = new Pose(56, 33);
    private final Pose pose3 = new Pose(15, 33);
    private final Pose pose4 = new Pose(50, 8);
    private final Pose pose5 = new Pose(56, 55);
    private final Pose pose6 = new Pose(15, 55);

    private PathChain goShot, hi, goshot2, path5, goShot3, path6, path7;
    ...
    public void buildPaths() {
        goShot = follower.pathBuilder()
                ...
                .build();
        hi = follower.pathBuilder()
                .addPath(new BezierLine(pose2, pose3))
                .setLinearHeadingInterpolation(Math.toRadians(180),Math.toRadians(180))
                .build();
        goshot2 = follower.pathBuilder()
                .addPath(new BezierLine(pose3, pose4))
                .setLinearHeadingInterpolation(Math.toRadians(180),Math.toRadians(120))
                .build();
        goShot3 = follower.pathBuilder()
                .addPath(new BezierLine(startPose, pose5))
        ...
        path6 = follower.pathBuilder()
                .addPath(new BezierLine(pose6, pose4))
