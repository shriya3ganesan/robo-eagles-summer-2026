...
@Autonomous(name = "simpleGoalRedAuto")
...
public class simpleGoalRedAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(95.37, 122.446, Math.toRadians(38)); // Start Pose of our robot.
    private final Pose shootPose = new Pose(41.32038834951456, 102.17475, Math.toRadians(28));
