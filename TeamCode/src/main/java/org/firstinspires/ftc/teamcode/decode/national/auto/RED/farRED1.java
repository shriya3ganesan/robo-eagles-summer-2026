...
@Autonomous(name = "AUTO FAR RED", group = "AAA RED")
public class farRED1 extends CommandOpMode {
    ...
    ArrayList<farRED1.Flicker> flickOrder = new ArrayList<>();
    ...
    private final Pose intakeDiagonalPose = new Pose (131, 12, Math.toRadians(340));
    private final Pose intakeHorizPose = new Pose (132, 10, Math.toRadians(0));
    private final Pose intakeHoriz2Pose = new Pose (128, 11, Math.toRadians(0));
    private final Pose intakePickup3 = new Pose (130.5, 35.4, Math.toRadians(0));
    private final Pose leavePose = new Pose (100, 16.78, Math.toRadians(0));
